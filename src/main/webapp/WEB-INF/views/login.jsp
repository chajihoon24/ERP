...
<%@ page pageEncoding="UTF-8" %>
   ...
   <div class="flex justify-center items-center min-w-full min-h-full mb-10">
    <div class="w-full md:w-1/2 flex flex-col items-center rounded p-4 mb-10 " >
        ...
        <div class="w-3/4 mb-6">
            <input type="email" name="email" id="email" class="w-full py-4 px-8 bg-slate-200 placeholder:font-semibold rounded hover:ring-1 outline-blue-500" placeholder="ID">
        </div>
        <!-- password input -->
        <div class="w-3/4 mb-6">
